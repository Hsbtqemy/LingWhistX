...
export function buildAlignmentWorkspaceProps(
  ...
  return {
    ...
    knownSpeakers: te.knownSpeakers,
    updateEditorSegmentSpeaker: te.updateEditorSegmentSpeaker,
    insertBlankSegment: te.insertBlankSegment,
...
export function buildTranscriptEditorPanelProps(
  ...
  return {
    ...
    canMergePrev: te.canMergePrev,
    canMergeNext: te.canMergeNext,
    deleteActiveSegment: te.deleteActiveSegment,
    canDeleteSegment: te.canDeleteSegment,

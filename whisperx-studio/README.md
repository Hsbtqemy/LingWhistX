...
- `src-tauri/target/release/bundle/msi/whisperx-studio_0.1.1_x64_en-US.msi`
- `src-tauri/target/release/bundle/nsis/whisperx-studio_0.1.1_x64-setup.exe`
...
- `src-tauri/target/release/portable/whisperx-studio_0.1.1_portable.exe`
- `src-tauri/target/release/portable/whisperx-studio_0.1.1_portable.exe.sha256`
